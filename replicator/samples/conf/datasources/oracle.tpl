...
replicator.datasource.oracle_extractor.connectionSpec.host=${replicator.global.db.host}
replicator.datasource.oracle_extractor.connectionSpec.port=${replicator.global.db.port}
replicator.datasource.oracle_extractor.connectionSpec.user=${replicator.global.db.user}
replicator.datasource.oracle_extractor.connectionSpec.password=${replicator.global.db.password}
